...
namespace :deploy do
  task :symlink_shared do
    run "ln -nfs #{shared_path}/config/database.yml #{release_path}/config/database.yml"# &&
    		#ln -nfs #{shared_path}/public/assets/themes/ #{current_path}/public/assets/themes && 
    		#ln -nfs #{shared_path}/public/uploads/themes/ #{current_path}/public/uploads/themes && 
    		#ln -nfs #{shared_path}/public/uploads/photo/ #{current_path}/public/uploads/photo
