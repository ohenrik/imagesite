...
describe "public_code_files/edit" do
  before(:each) do
  ...
  it "renders the edit public_code_file form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form[action=?][method=?]", public_code_file_path(@public_code_file), "post" do
