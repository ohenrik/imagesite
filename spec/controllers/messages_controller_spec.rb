  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved message as @message" do
        ...
        post :create, {:message => { "subject" => "invalid value" }}, valid_session
        assigns(:message).should be_a_new(Message)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested message" do
        ...
        put :update, {:id => message.to_param, :message => { "subject" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the message as @message" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Message.any_instance.stub(:save).and_return(false)
        put :update, {:id => message.to_param, :message => { "subject" => "invalid value" }}, valid_session
        assigns(:message).should eq(message)
      end
